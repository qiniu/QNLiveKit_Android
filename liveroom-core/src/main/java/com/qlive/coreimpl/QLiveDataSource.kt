...
class QLiveDataSource {
    ...
    suspend fun refreshRoomInfo(liveId: String): QLiveRoomInfo {
        return HttpService.httpClient.get(
    ...
    suspend fun profile(): InnerUser {
        return HttpService.httpClient.get("/client/user/profile", null, InnerUser::class.java)
    }

    suspend fun appConfig(): AppConfig {
        return HttpService.httpClient.get("/client/app/config", null, AppConfig::class.java)
    }
    ...
    suspend fun listRoom(pageNumber: Int, pageSize: Int): PageData<QLiveRoomInfo> {
        ...
        val date: PageData<QLiveRoomInfo> =
            HttpService.httpClient.get("/client/live/room/list", HashMap<String, String>().apply {
    ...
    suspend fun createRoom(param: QCreateRoomParam): QLiveRoomInfo {
        return HttpService.httpClient.post(
    ...
    suspend fun unPubRoom(liveId: String): QLiveRoomInfo {
        return HttpService.httpClient.delete(
            "/client/live/room/${liveId}",
            "{}",
            QLiveRoomInfo::class.java
        )
    ...
    suspend fun leaveRoom(liveId: String) {
        HttpService.httpClient.delete("/client/live/room/user/${liveId}", "{}", Any::class.java)
    }
    ...
    suspend fun getOnlineUser(
        ...
        val data: PageData<QLiveUser> = HttpService.httpClient.get(
    ...
    suspend fun searchUserByUserId(uid: String): QLiveUser {
        ...
        val list = HttpService.httpClient.get<List<QLiveUser>>(
            "/client/user/users",
            HashMap<String, String>().apply {
                put("user_ids", uid)
            },
    ...
    suspend fun getToken() = suspendCoroutine<String> { coroutine ->
        HttpService.httpClient.tokenGetter!!.getTokenInfo(object : QLiveCallBack<String> {
            override fun onError(code: Int, msg: String?) {
                coroutine.resumeWithException(NetBzException(code, msg))
            }

            override fun onSuccess(data: String) {
                HttpService.httpClient.token = data
    ...
    suspend fun updateUser(
        ...
        HttpService.httpClient.put("/client/user/user", JsonUtils.toJson(user), Any::class.java)
    }
}