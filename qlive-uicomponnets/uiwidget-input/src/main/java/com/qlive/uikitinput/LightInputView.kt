...
import com.qlive.uikitinput.databinding.KitMvRoomInputLightBinding

class LightInputView : FrameLayout, IInputView {

    private var binding: KitMvRoomInputLightBinding
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        binding = KitMvRoomInputLightBinding.inflate(LayoutInflater.from(context), this, true)
        init()
    }
