...
import com.qlive.uikitinput.databinding.KitMvRoomInputBinding

class DarkInputView : FrameLayout, IInputView {
    private lateinit var binding: KitMvRoomInputBinding
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        binding = KitMvRoomInputBinding.inflate(LayoutInflater.from(context), this, true)
        init()
    }
